    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          v-hasPerm="['dict_del']"
        >
          <el-tooltip content="清空字典数据缓存" placement="top">
...
<script>
  import {listDict, getDict, delDict, cleanCache, addDict, editDict, exportDict} from "@/api/system/dict";
  import {updateCache} from "@/api/system/dictData";
