    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          v-hasPerm="['dict_edit']"
        >
          <el-tooltip content="更新字典数据信息" placement="top">
...
<script>
import { listData, getData, delData, addData, editData, updateCache, exportData } from "@/api/system/dictData";
